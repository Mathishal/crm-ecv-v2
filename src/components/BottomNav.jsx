    ...
    <>
      ...
      <div style={{
        ...
        <div style={{padding:"20px 20px 16px",borderBottom:"1px solid #e2e8f0",display:"flex",alignItems:"center",gap:"12px"}}>
          ...
          <button
            onClick={() => setOpen(false)}
            style={{marginLeft:"auto",background:"none",color:"#94a3b8",boxShadow:"none",padding:"4px",fontSize:"20px"}}
          >✕</button>
        </div>
        ...
        <div style={{flex:1,overflowY:"auto",padding:"12px 10px"}}>
          {tabs.map(tab => (
            ...
            >
              ...
              {tab.label}
              {activeTab === tab.key && (
                <span style={{marginLeft:"auto",width:"6px",height:"6px",borderRadius:"50%",background:"#22723a",flexShrink:0}} />
              )}
            </button>
          ))}
        </div>
        ...
        <div style={{padding:"12px 10px",borderTop:"1px solid #e2e8f0"}}>
          <button
            ...
            style={{width:"100%",display:"flex",alignItems:"center",gap:"14px",padding:"12px 14px",borderRadius:"10px",background:"#fdf1f1",color:"#d63b3b",fontWeight:600,fontSize:"14px",boxShadow:"none",justifyContent:"flex-start"}}
          >
      ...
      {/* Burger button — fixé en haut à gauche */}
      <button
